...
class MasterViewController:UICollectionViewController,  NSFetchedResultsControllerDelegate, FormViewControllerDelegate {
    ...
    func formControllerDidFinish(controller:FormViewController, model:FormModel){
        ...
        newManagedObject.setValue(model.Image, forKey: "image")
        newManagedObject.setValue(model.Name, forKey: "name")
        newManagedObject.setValue(model.Desc, forKey: "desc")
        newManagedObject.setValue(model.Lng, forKey: "Lng")
        newManagedObject.setValue(model.Ltd, forKey: "Lat")
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        var imageURL: String = object.valueForKey("image")!.description
